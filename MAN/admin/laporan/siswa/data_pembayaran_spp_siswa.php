<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Pembayaran Iuran Sumbangan Pendidikan (SPP)</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
                  ...
                  if (isset($_POST['filter'])) {
                   ...
                   ?>
					...
					<tr>
						...
						<td>
							<a href="admin/laporan/siswa/cetak_pembayaran_spp_per_siswa.php?id_siswa=<?php echo $data['id_siswa'] ?>&id_tahun_ajaran=<?php echo $id_tahun_ajaran ?>" title="Cetak" target="_blank"
