<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Pembayaran Guru</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
                  ...
                  if (isset($_POST['filter'])) {
                   ...
                   ?>
					...
					<tr>
						...
						<td>
							<a href="admin/laporan/guru/cetak_pembayaran_gaji_per_guru.php?id_guru=<?php echo $data['id_guru'] ?>&id_tahun_ajaran=<?php echo $id_tahun_ajaran ?>" title="Cetak" target="_blank"
