          ...
          <div class="col-md-3">
            ...
            ?>
					...
					<tr>
						...
						<td>
							<a href="?page=transaksi-pemasukan&&id_pemasukan=<?php echo $data2['id_pemasukan'] ?>&id_tahun_ajaran=<?php echo $data2['id_tahun_ajaran']; ?>" title="Detail Pembayaran"
