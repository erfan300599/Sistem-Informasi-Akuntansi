...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Jenis Pemasukan Lainnya</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
          ...
          <div class="col-md-3">
            ...
            ?>
					...
					<tr>
						...
						<td>
							<a href="?page=edit-pemasukan-lain&kode=<?php echo $data['id_pemasukan']; ?>" title="Ubah"
							 class="btn btn-success btn-sm">
								<i class="fa fa-edit"></i>
							</a>
							<a href="?page=del-pemasukan-lain&kode=<?php echo $data['id_pemasukan']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
