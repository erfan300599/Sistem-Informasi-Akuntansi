                  ...
                  if (isset($_POST['filter'])) {
                   ...
                   ?>
					...
					<tr>
						...
						<td>
							<a href="?page=hapus-pemasukan&id_tagihan_pemasukan=<?php echo $data['id_tagihan_pemasukan']; ?>&id_pemasukan=<?php echo $id_pemasukan?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
