	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="user_postingan" name="user_postingan" value="Admin" readonly>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
    	 	$fileName = $_FILES['gambar_berita']['name'];
    	 	   move_uploaded_file($_FILES['gambar_berita']['tmp_name'], "admin/gambar/berita/" . $_FILES['gambar_berita']['name']);
