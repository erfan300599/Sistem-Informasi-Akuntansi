	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_bayar_guru" name="nama_bayar_guru" placeholder="Nama Pembayaran" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
						<select name="tipe_jenis_bayar_guru" id="tipe_jenis_bayar_guru" class="form-control" required>
...
<script type="text/javascript" src="admin/ckeditor/ckeditor.js"></script>
    ...
    //mulai proses simpan data
      	  $sql_simpan = "INSERT INTO tb_jenis_bayar_guru (id_tahun_ajaran, nama_bayar_guru, tipe_jenis_bayar_guru) VALUES (
            '".$_POST['id_tahun_ajaran']."',
            '".$_POST['nama_bayar_guru']."',
            '".$_POST['tipe_jenis_bayar_guru']."')";
