				...
				<tbody>
					...
					?>
							...
							<tr>
								...
								<td>
									<a href="?page=hapus-pengeluaran&id_tagihan_pengeluaran=<?php echo $data['id_tagihan_pengeluaran']; ?>&id_pengeluaran=<?php echo $id_pengeluaran ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
