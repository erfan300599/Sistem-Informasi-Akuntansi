...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Jenis Pengeluaran Lainnya
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
				...
				<tbody>
					...
					?>
							...
							<i class="fa fa-cogs"></i> Setting Pembayaran
								...
								<td>
									<a href="?page=edit-pengeluaran-lain&kode=<?php echo $data['id_pengeluaran']; ?>" title="Ubah" class="btn btn-success btn-sm">
										<i class="fa fa-edit"></i>
									</a>
									<a href="?page=del-pengeluaran-lain&kode=<?php echo $data['id_pengeluaran']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
