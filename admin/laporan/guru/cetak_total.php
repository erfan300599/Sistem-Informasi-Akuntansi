...
if ($sqlTahunAjaranAktif->num_rows > 0) {
    ...
    // Query untuk mengambil data jumlah tagihan bulanan yang sudah terbayar
    $sql = $koneksi->query("SELECT tb_tahun_ajaran.tahun_ajaran, 
                            SUM(tb_tagihan_bulanan_guru.terbayar) AS total_pembayaran, 
                            SUM(tb_tagihan_bulanan_guru.jml_bayar - tb_tagihan_bulanan_guru.terbayar) AS total_belum_terbayar 
                        FROM tb_tahun_ajaran
                        LEFT JOIN tb_jenis_bayar_guru ON tb_tahun_ajaran.id_tahun_ajaran = tb_jenis_bayar_guru.id_tahun_ajaran
                        LEFT JOIN tb_tagihan_bulanan_guru ON tb_jenis_bayar_guru.id_jenis_bayar_guru = tb_tagihan_bulanan_guru.id_jenis_bayar_guru
...
?>
        ...
        <head>
            ...
            <title>Cetak - Total Penggajian Guru</title>
        </head>
...
<?php
        ...
        echo "Tidak ada data tagihan bulanan pada tahun ajaran aktif.";
    }
} else {
