<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Pembayaran Iuran Sumbangan Pendidikan (SPP)
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<form action="" method="post">
					...
					<div class="col-sm-12">
						<a href="admin/laporan/siswa/cetak_seluruh_SPP.php" class="btn btn-primary" target="_blank">
				...
				<tbody>
					...
					?>
							...
							<tr>
								...
								<td>
									<a href="admin/laporan/siswa/cetak_pembayaran_spp_per_siswa.php?id_siswa=<?php echo $data['id_siswa'] ?>&id_tahun_ajaran=<?php echo $id_tahun_ajaran ?>" title="Cetak" target="_blank" class="btn btn-primary btn-sm">
