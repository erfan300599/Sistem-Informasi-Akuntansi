...
if ($sqlTahunAjaranAktif->num_rows > 0) {
    ...
    $sql = $koneksi->query("SELECT tb_tahun_ajaran.tahun_ajaran, 
                            SUM(tb_tagihan_bulanan_siswa.terbayar) AS total_pembayaran, 
                            SUM(tb_tagihan_bulanan_siswa.jml_bayar - tb_tagihan_bulanan_siswa.terbayar) AS total_belum_terbayar 
                        ...
                        LEFT JOIN tb_tagihan_bulanan_siswa ON tb_jenis_bayar_siswa.id_jenis_bayar_siswa = tb_tagihan_bulanan_siswa.id_jenis_bayar_siswa
...
?>
        ...
        <body onload="window.print()">
            ...
            <div align="center">
                <h2>PEMBAYARAN SPP SEMUA SISWA</h2>
            </div>
